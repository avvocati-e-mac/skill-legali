# CLAUDE.md / AGENTS.md — Regole per sviluppare i test in questa cartella

> Guida operativa per chiunque aggiunga o modifichi test/benchmark qui.
...
- Questa regola locale si aggiunge alla regola generale della root del repository.
...
2. Red teaming → `RED_TEAM_V{n}.md`.
3. Report → `REPORT_COMPLETO_V{n}.md` + `multijudge/RESULT_V{n}.md`.
...
- Questo file, il suo gemello `AGENTS.md` e `ARCHITETTURA_TEST.md` sono **vivi**: aggiornali quando cambiano metriche, criteri o convenzioni.
