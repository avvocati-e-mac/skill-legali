# Bibliografia di rimando

Apri questo file quando l'utente chiede i riferimenti bibliografici
completi per approfondire di persona un autore o un testo citato nelle
altre reference.

**Nota di trasparenza importante:** tutto il materiale raccolto in questa
skill (via perplexity-web-mcp) è **sintesi/estratti di terze parti sui
testi**, non lettura diretta dei testi integrali. Non è stato possibile
esaminare per esteso i libri originali qui elencati: Perplexity restituisce
sintesi basate su recensioni, cataloghi editoriali, estratti disponibili
online e pagine terze, non i testi integrali (che sono libri a
...
## Linguaggio amministrativo e istituzionale

- Michele Cortelazzo, *Il linguaggio amministrativo. Principi e pratiche
  di modernizzazione* (Carocci, 2021).
- Michele Cortelazzo (a cura di), *Guida alla scrittura istituzionale*
  (Laterza, 2003).
- Michele Cortelazzo, *Il comune scrive chiaro* (Maggioli, 2005).
- *Codice di stile delle comunicazioni scritte ad uso delle
  amministrazioni pubbliche* (Dipartimento della Funzione Pubblica, 1993).

## Tecnica normativa

- *Guida alla redazione dei testi normativi* (circolare Presidenza del
  Consiglio dei Ministri, 2 maggio 2001, n. 10888, pubblicata in Gazzetta
  Ufficiale).
- *Regole e raccomandazioni per la formulazione tecnica dei testi
  legislativi* (lettera circolare 20 aprile 2001, Presidenti delle Camere
  e Presidente del Consiglio, raccolta a cura del Senato).
...
- Protocollo per la redazione degli atti processuali civili, Osservatorio
  Giustizia Civile di Bologna.

## Normativa e giurisprudenza citate (per riferimento rapido)
