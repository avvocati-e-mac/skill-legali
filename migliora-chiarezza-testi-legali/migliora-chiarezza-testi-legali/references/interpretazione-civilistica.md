...
La Cassazione ribadisce costantemente che l'art. 1370 c.c. è un'**ultima
ratio**, non il primo strumento:
1. Criterio letterale (art. 1362, primo comma).
2. Se ambiguo, criteri "integrativi" degli artt. 1362 (intenzione comune)
   e 1363 (interpretazione sistematica).
3. Solo se l'ambiguità persiste, si ricorre al contra proferentem (art.
   1370) e alle regole finali (art. 1371).

Ordinanze recenti **Cass. Sez. III, n. 3013/2025 e n. 6444/2025**
confermano questa gerarchia: il criterio letterale viene prima; solo in
presenza di ambiguità persistente il giudice applica l'art. 1370 c.c.
interpretando le clausole in senso favorevole alla parte non
predisponente. Un redattore che sa di questa gerarchia ha un incentivo
concreto: eliminare l'ambiguità letterale a monte è sempre meglio che
...
## Esempio: dalla clausola vaga alla riscrittura preventiva

Clausola del contratto di noleggio esaminato:
"Il Noleggiatore garantisce che [...] l'impianto refrigerante è
...
1. La clausola riflette la volontà reale delle parti o è una formula
   standard non verificata rispetto al caso concreto? (art. 1362)
2. È coerente con le altre clausole del contratto, senza contraddizioni
   nei rinvii o nelle definizioni? (art. 1363)
3. Le espressioni generali o gli esempi sono chiaramente delimitati
   (esemplificativi vs. limitativi)? (artt. 1364-1365)
4. Contiene un "trabocchetto" interpretativo che una lettura in buona fede
   smonterebbe comunque a sfavore di chi l'ha scritta? (art. 1366)
5. Se dubbia, la clausola rischia di travolgere l'intero contratto invece
   di essere isolabile? (art. 1367)
6. La terminologia è coerente con gli usi del settore, o rischia
   un'interpretazione settoriale imprevista? (art. 1368)
7. Contiene parole "polisenso" non definite (es. "corrispettivo",
   "indennità", "penale", standard soggettivi come "perfettamente
