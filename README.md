...
|------|-------|---------------|
| 18 giugno 2026 | **Concilio di LLM** | Ottimizzazione token e affidabilità: verifica delle norme e controllo di forma delle citazioni di giurisprudenza ora **deterministici** (script Python, niente token sprecati dall'IA); per le citazioni inventate il controllo automatico **prevale** sul parere dell'IA. Aggiunti strumenti di test e un "profilo" che misura dove si spende, istruzioni per l'uso fuori sandbox in Codex con un'unica richiesta di autorizzazione, e funzioni opzionali (disattivate di default) per ridurre i token. Tutte le ricerche e le scelte sono registrate in `ARCHITETTURA.md` |
